...
First, for all differentially expressed genes ![all differentially expressed genes results](figures/all_de_genes_results.png)\
...
GO:BP \
![all BP](figures/all_de_genes_BP.png)
![all BP](figures/all_BP_top10.png)
